...
public class UIResourcesLoader {
	...
	private UIResourcesLoader() {
		...
		try {
			String backg ="NineMensMorris/images/backgrounds/";
			mainmenu_bg = ImageIO.read(new File(backg+"mainmenu_bg.png"));
			settings_bg = ImageIO.read(new File(backg+"settings_bg.png"));
			about_bg = ImageIO.read(new File(backg+"about.png"));
			devteam_bg = ImageIO.read(new File(backg+"devteam.png"));
			newgame_bg = ImageIO.read(new File(backg+"newgame_bg.png"));
			game_bg = ImageIO.read(new File(backg+"game.png"));
		} catch (IOException e) {
			e.printStackTrace();
	...
	private void initStrings() {
		try {
			String strings="NineMensMorris/images/strings/";
			youStr = new GameImage(strings+"you.png");
			
			v_gamePhases = new Image[3];
			v_gamePhases[0] = ImageIO.read(new File(strings+"placing.png"));
			v_gamePhases[1] = ImageIO.read(new File(strings+"moving.png"));
			v_gamePhases[2] = ImageIO.read(new File(strings+"flying.png"));
			
			v_gameStatus = new Image[9];
			v_gameStatus[0] = ImageIO.read(new File(strings+"placePiece.png"));
			v_gameStatus[1] = ImageIO.read(new File(strings+"selectPiece.png"));
			v_gameStatus[2] = ImageIO.read(new File(strings+"movePiece.png"));
			v_gameStatus[3] = ImageIO.read(new File(strings+"removePiece.png"));
			v_gameStatus[4] = ImageIO.read(new File(strings+"flyPiece.png"));
			v_gameStatus[5] = ImageIO.read(new File(strings+"waitingAI.png"));
			v_gameStatus[6] = ImageIO.read(new File(strings+"p1Won.png"));
			v_gameStatus[7] = ImageIO.read(new File(strings+"p2Won.png"));
			v_gameStatus[8] = ImageIO.read(new File(strings+"draw.png"));
		} catch (IOException e) {
			e.printStackTrace();
			System.out.println("Background Resources Missing");
			System.exit(-1);
	...
	private void initImages() {
		try {
			v_turns = new Image[2];
			String we = "NineMensMorris/images/pieces/";
			String me ="NineMensMorris/images/buttons/";
			String back ="NineMensMorris/images/backgrounds/";

			v_turns[0] = ImageIO.read(new File(we+"turnP1.png"));
			v_turns[1] = ImageIO.read(new File(we+"turnP2.png"));
			gameLevelCheck = new GameImage(me+"check.png");
			waitingForConnection = new GameImage(back+"waitingConnection.png", 0, 0);
			confirmReset = new GameImage(back+"confirmReset.png", 0, 0);
		} catch(IOException e) {
			e.printStackTrace();
	...
	private void initBtns() {
		...
		try {
			String buttons= "NineMensMorris/images/buttons/";
			v_unselectedNewGameBtn[LOCAL_GAME] = ImageIO.read(new File(buttons+"local_uns.png"));
			v_unselectedNewGameBtn[NETWORK_GAME] = ImageIO.read(new File(buttons+"network_uns.png"));
			v_unselectedNewGameBtn[SERVER_GAME] = ImageIO.read(new File(buttons+"server_uns.png"));
			v_unselectedNewGameBtn[CLIENT_GAME] = ImageIO.read(new File(buttons+"client_uns.png"));
			v_unselectedNewGameBtn[HUM_HUM_GAME] = ImageIO.read(new File(buttons+"h-h_uns.png"));
			v_unselectedNewGameBtn[HUM_CPU_GAME] = ImageIO.read(new File(buttons+"h-c_uns.png"));
			v_unselectedNewGameBtn[CPU_CPU_GAME] = ImageIO.read(new File(buttons+"c-c_uns.png"));
			v_selectedNewGameBtn[LOCAL_GAME] = ImageIO.read(new File(buttons+"local_sel.png"));
			v_selectedNewGameBtn[NETWORK_GAME] = ImageIO.read(new File(buttons+"network_sel.png"));
			v_selectedNewGameBtn[SERVER_GAME] = ImageIO.read(new File(buttons+"server_sel.png"));
			v_selectedNewGameBtn[CLIENT_GAME] = ImageIO.read(new File(buttons+"client_sel.png"));
			v_selectedNewGameBtn[HUM_HUM_GAME] = ImageIO.read(new File(buttons+"h-h_sel.png"));
			v_selectedNewGameBtn[HUM_CPU_GAME] = ImageIO.read(new File(buttons+"h-c_sel.png"));
			v_selectedNewGameBtn[CPU_CPU_GAME] = ImageIO.read(new File(buttons+"c-c_sel.png"));
			
			returnToGameBtn = new GameImage(buttons+"return_game.png", 993, 663);
			startGameBtn = new GameImage(buttons+"start_game.png", 272, 640);
		} catch(IOException e) {
			e.printStackTrace();
			System.out.println("Resources missing");
			System.exit(-1);
	...
	private void initPieces() {
		try {
			...
			String we = "NineMensMorris/images/pieces/";
			v_unselectedPieces[0] = ImageIO.read(new File(we + "pieceP1_uns.png"));
			v_unselectedPieces[1] = ImageIO.read(new File(we + "pieceP2_uns.png"));
			v_selectedPieces[0] = ImageIO.read(new File(we + "pieceP1_sel.png"));
			v_selectedPieces[1] = ImageIO.read(new File(we + "pieceP2_sel.png"));
		} catch (IOException e) {
			e.printStackTrace();
			System.out.println("Resources missing");
			System.exit(-1);
